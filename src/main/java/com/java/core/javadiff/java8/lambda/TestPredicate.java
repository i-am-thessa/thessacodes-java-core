...
public class TestPredicate {
    public static void main(String[] args) {
        /*Evaluate<T> is a functional interface i.e. one abstract: boolean
        isNegative(T t); similar to java.util.function.Predicate*/
        ...
        * boolean test(T t)*/
        ...
        System.out.println("Does " + name + " start with Mr. ? " + check("Mr" +
                ". Joe Bloggs", s -> s.startsWith("Mr. "))); //true
        System.out.println("Does " + name + " start with Mr. ? " + check("Ms" +
                ". Joe Bloggs", s -> s.startsWith("Mr. "))); //false
    }
